...
String.prototype.secret_global_match = function (regex) {
    console.log('TODO: Global match prototype is new and needs better modeling ' + regex);
    ...
    do {
        ...
        result.push(match[0]);
        remaining = remaining.substr(match.index + match[0].length);
        console.log('NM', match[0], 'remain', remaining);
    } while (true);
