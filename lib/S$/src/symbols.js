...
AssertToolkit.symbol = function(name, c) {
    if (c instanceof Array && c.length == 0) {
        return AssertToolkit.symbolicArray(name);
    } else if (c instanceof Object && !(c instanceof Array)) {
        return AssertToolkit.symbolicObject(name, c);
    } else {
...
AssertToolkit.pureSymbol = function(name) {
    ...
    switch (name_type) {
        ...
        case 5:
            return AssertToolkit.symbol(name + '_object', {});
        default:
