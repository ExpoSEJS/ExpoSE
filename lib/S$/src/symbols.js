...
function __mark_safe_native__(f) {}
...
AssertToolkit.markSafe = __mark_safe_native__;
...
/*
 * Models for safe to native functions need their own little place
 */

 AssertToolkit.markSafe(Array.prototype.push);
 AssertToolkit.markSafe(Array.prototype.keys);
 AssertToolkit.markSafe(Array.prototype.forEach);
 AssertToolkit.markSafe(Array.prototype.filter);
 AssertToolkit.markSafe(Array.prototype.map);
